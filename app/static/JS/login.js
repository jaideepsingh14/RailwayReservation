...
$(document).ready(function() {
	...
	$('[name="btnNEXT"]').click(function() {
		console.log("uname on login button" + name_arr[0]);
		console.log("pass on login button" + name_arr[1]);
		$(".five").slideUp(0);
		$(".five").slideDown(500);
		$.ajax({
			type: 'POST',
			...
			success: function(result) {
				console.log("Result for login button" + result);
				if (result == "0") {
					...
					console.log("Result is not 0. Return value is different from flask function namely login");
